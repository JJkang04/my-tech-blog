...
export default function Home() {
  ...
  return (
    <FadeIn>
      <div className="py-10">
        <h1 className="text-3xl font-bold mb-4 dark:text-white">예비 개발자의 기술 블로그입니다</h1>
        ...
        <div className="flex flex-wrap gap-2 mb-10">
          {categories.map((cat:string) => (
            <Link
              ...
              rounded-full text-sm hover:bg-blue-500 hover:text-white tansition-colors">
                #{cat}
              </Link>
          ))}
        </div>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4 dark:text-white">최근 게시글 </h2>
